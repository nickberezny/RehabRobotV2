...
function (_React$Component) {
  ...
  function WindowContent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleEndStage", function (message) {
      ...
      _this.props.setValue('stage', _this.props.stage + 1);

      _this.props.setValue('run', 0);

      _this.props.setValue('xdes', 0.0);

      _this.props.setValue('x', 0.0);

      switch (_this.props.exp) {
        case 1:
          //assist/resist ranges (exp 1)
          _this.props.setValue('game', 1);
        ...
        case 2:
          ...
          switch (_this.props.stage) {
            case 1:
              _this.props.setValue('game', 3);

              break;

            case 2:
              _this.props.setValue('game', 4);

              break;

            case 3:
              _this.props.setValue('game', 5);
...
//# sourceMappingURL=index.js.58c871b2e4dbefa37a7f.hot-update.js.map