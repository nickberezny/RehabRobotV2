...
function (_Component) {
  ...
  _createClass(Follow_game, [{
    ...
    value: function componentDidMount() {
      ...
      var camera = new three__WEBPACK_IMPORTED_MODULE_2__["PerspectiveCamera"](70, window.innerWidth / window.innerHeight, 0.1, 2000);
    ...
    value: function animate() {
      ...
      if (1) {
        ...
        this.camera.position.x = 50 * Math.cos(this.timer);
        this.camera.position.y = 50 * Math.cos(this.timer);
...
//# sourceMappingURL=index.js.e34c6b7257ee8858ad69.hot-update.js.map