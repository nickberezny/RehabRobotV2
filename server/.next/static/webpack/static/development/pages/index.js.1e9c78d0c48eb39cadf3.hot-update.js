...
function (_Component) {
  ...
  _createClass(Follow_game, [{
    ...
    value: function componentDidMount() {
      ...
      foot.position.set(0.0, 62.5, -100);
    ...
    value: function animate() {
      if (!this.start_game) {
        ...
        this.cube.position.y = this.props.x_ball;
        this.foot.position.y = this.props.x; //console.log('x_end' + this.props.x_end)
...
//# sourceMappingURL=index.js.1e9c78d0c48eb39cadf3.hot-update.js.map