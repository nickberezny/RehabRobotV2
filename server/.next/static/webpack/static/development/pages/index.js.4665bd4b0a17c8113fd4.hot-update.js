...
function (_Component) {
  ...
  _createClass(Follow_game, [{
    ...
    value: function componentDidMount() {
      ...
      cube.position.set(10.0, 0.0, -100);
      foot.position.set(0.0, 0.0, -100);
    ...
    value: function animate() {
      ...
      } else {//this.cube.position.x = this.props.x_ball
...
//# sourceMappingURL=index.js.4665bd4b0a17c8113fd4.hot-update.js.map